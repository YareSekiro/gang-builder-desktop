...
{
    public class PhoneUserContacts
    {
        private List<object> _id;
        private List<object> _identifier;
        private List<object> _number;
        private List<object> _display;
        public List<object> Id { get => _id; set => _id = value; }
        public List<object> Identifier { get => _identifier; set => _identifier = value; }
        public List<object> Number { get => _number; set => _number = value; }
        public List<object> Display { get => _display; set => _display = value; }

        public PhoneUserContacts(Dictionary<string, List<Object>> _d)
        {
            this.Hydrate(_d);
        }
